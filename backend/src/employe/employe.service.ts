...
export class EmployeService {
  ...
  async create(createEmployeDto: CreateEmployeDto): Promise<ApiResponse<EmployeResponse>> {
    try {
  ...
  async findAll(): Promise<ApiResponse<EmployeResponse[]>> {
    try {
  ...
  async findOne(id: number): Promise<ApiResponse<EmployeResponse>> {
    try {
  ...
  async update(id: number, updateEmployeDto: UpdateEmployeDto): Promise<ApiResponse<EmployeResponse>> {
    try {
      const employe = await this.prisma.employe.findUnique({
        where: { idEmploye: id },
      });
