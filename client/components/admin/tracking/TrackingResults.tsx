...
export function TrackingResults({ tracking }: TrackingResultsProps) {
  const getStatusColor = (status: Tracking["status"]) => {
    switch (status) {
      ...
      case "Préparation": return "bg-yellow-500";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">{tracking.origin} → {tracking.destination}</p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <p className="text-sm text-muted-foreground">{completedStages} / {totalStages} étapes terminées</p>
              </div>
